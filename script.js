...
function handlePostFormSubmit(event) {
  ...
  const newPost = {
    ...
    author: 'YourName', // You can modify this to get the author dynamically
  ...
  //   postsData.unshift(newPost); // Add the new post to the beginning of the array
  postsData.push(newPost);
  // Reset the form inputs
  postInput.value = '';
  imageInput.value = '';
  console.log(postsData);
  // Render the posts with the new post
  renderPosts();
}
